...
<section class="page-section text-white text-center py-5" id="portfolio" style="background-color: #d294c9;">
    <div class="container">
        ...
        <a class="btn btn-lg font-weight-bold" href="{{url('portafolio')}}" style="background-color: #f8c8dc; border-color: #121011; border-width: 3px; color: #000;">
...
<section class="page-section text-white text-center py-5" style="background-color: #f8c8e0; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1); font-family: 'Poppins', sans-serif;">
    <div class="container">
        ...
        <a class="btn btn-lg font-weight-bold" href="{{url('nuevoProducto')}}" style="background-color: #e59ce7; border-color: #9b13a5; border-width: 3px; color: white;">
            Registrate ahora
        </a>
    </div>
</section>
